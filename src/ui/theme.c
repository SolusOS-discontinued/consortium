...
/**
 * \file theme.c    Making Consortium look pretty
 *
 * The window decorations drawn by Consortium are described by files on disk
 * known internally as "themes" (externally as "window border themes" on
 * http://art.gnome.org/themes/consortium/ or "Consortium themes"). This file
 ...
 * called from outside Consortium, in which case env->theme will be NULL, and
