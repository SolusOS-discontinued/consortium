 ...
 *
 * This is a list of the names of all the X atoms that Consortium uses.
...
item(WM_ICON_SIZE)
item(_KWM_WIN_ICON)
item(_CONSORTIUM_RESTART_MESSAGE)    
item(_CONSORTIUM_RELOAD_THEME_MESSAGE)
item(_CONSORTIUM_SET_KEYBINDINGS_MESSAGE)
item(_CONSORTIUM_TOGGLE_VERBOSE)
item(_CONSORT_PANEL_ACTION)
item(_CONSORT_PANEL_ACTION_MAIN_MENU)
item(_CONSORT_PANEL_ACTION_RUN_DIALOG)
item(_CONSORTIUM_SENTINEL)
item(_CONSORTIUM_VERSION)
