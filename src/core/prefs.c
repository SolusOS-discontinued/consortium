...
#define SCHEMA_CONSORTIUM        "org.consort.consortium"
...
meta_prefs_init (void)
{
  ...
  settings = g_settings_new (SCHEMA_CONSORTIUM);
  g_signal_connect (settings, "changed", G_CALLBACK (settings_changed), NULL);
  g_hash_table_insert (settings_schemas, SCHEMA_CONSORTIUM, settings);
...
{
  g_settings_set_boolean (SETTINGS (SCHEMA_CONSORTIUM), KEY_COMPOSITOR, whether);
}
