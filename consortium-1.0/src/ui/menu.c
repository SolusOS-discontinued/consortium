...
static MenuItem menuitems[] = {
  ...
  { META_MENU_OP_MINIMIZE, MENU_ITEM_IMAGE, CONSORTIUM_STOCK_MINIMIZE, FALSE, N_("Mi_nimize") },
  /* Translators: Translate this string the same way as you do in libwnck! */
  { META_MENU_OP_MAXIMIZE, MENU_ITEM_IMAGE, CONSORTIUM_STOCK_MAXIMIZE, FALSE, N_("Ma_ximize") },
  /* Translators: Translate this string the same way as you do in libwnck! */
  ...
  /* Translators: Translate this string the same way as you do in libwnck! */
  { META_MENU_OP_DELETE, MENU_ITEM_IMAGE, CONSORTIUM_STOCK_DELETE, FALSE, N_("_Close") }
};
