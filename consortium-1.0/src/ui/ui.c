...
/* Consortium interface for talking to GTK+ UI module */
...
meta_stock_icons_init (void)
{
  ...
  MetaStockIcon items[] =
  {
    { CONSORTIUM_STOCK_DELETE,   stock_delete_data   },
    { CONSORTIUM_STOCK_MINIMIZE, stock_minimize_data },
    { CONSORTIUM_STOCK_MAXIMIZE, stock_maximize_data }
  };
