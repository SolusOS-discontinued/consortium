                         ...
                         MetaGradientType type)
{
  ...
  switch (type)
    ...
    case META_GRADIENT_VERTICAL:
      g_printerr ("consortium: vertical alpha channel gradient not implemented yet\n");
      break;
      
    case META_GRADIENT_DIAGONAL:
      g_printerr ("consortium: diagonal alpha channel gradient not implemented yet\n");
      break;
